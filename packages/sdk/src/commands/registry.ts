...
export const allCommands = [domainReloadCommand, executeCommand, logsCommand, statusCommand, sceneListCommand, sceneHierarchyCommand, sceneActiveCommand, sceneCreateCommand, sceneOpenCommand, testListCommand, testRunCommand] as const
