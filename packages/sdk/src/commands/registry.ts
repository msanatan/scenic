...
import { gameObjectCreateCommand } from './gameobject/contract.ts'
...
export const allCommands = [domainReloadCommand, executeCommand, gameObjectCreateCommand, logsCommand, statusCommand, sceneListCommand, sceneHierarchyCommand, sceneActiveCommand, sceneCreateCommand, sceneOpenCommand, testListCommand, testRunCommand] as const
