...
import { gameObjectCreateCommand, gameObjectDestroyCommand, gameObjectReparentCommand, gameObjectUpdateCommand } from './gameobject/contract.ts'
...
export const allCommands = [domainReloadCommand, executeCommand, gameObjectCreateCommand, gameObjectDestroyCommand, gameObjectUpdateCommand, gameObjectReparentCommand, logsCommand, statusCommand, sceneListCommand, sceneHierarchyCommand, sceneActiveCommand, sceneCreateCommand, sceneOpenCommand, testListCommand, testRunCommand] as const
